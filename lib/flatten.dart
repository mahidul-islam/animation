...
class FlattenCharacter extends StatefulWidget {
  const FlattenCharacter({super.key});

  @override
  _FlattenCharacterState createState() => _FlattenCharacterState();
}

class _FlattenCharacterState extends State<FlattenCharacter>
